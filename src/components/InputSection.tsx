    ...
    <>
      ...
      <div className="w-full max-w-5xl mx-auto animate-fade-in space-y-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          <ModernCard
            variant="floating"
            className="p-6 hover:shadow-2xl transition-all duration-300 w-[320px] min-w-[320px] sm:w-full sm:max-w-md mx-auto hover:scale-[1.02] hover:-translate-y-1 bg-gradient-to-br from-gray-50 to-gray-100 backdrop-blur-sm rounded-[29px] border-2 border-gray-200/30 shadow-xl shadow-gray-900/20"
          >
          ...
          <ModernCard
            variant="floating"
            className="p-6 hover:shadow-2xl transition-all duration-300 w-[320px] min-w-[320px] sm:w-full sm:max-w-md mx-auto hover:scale-[1.02] hover:-translate-y-1 bg-gradient-to-br from-gray-50 to-gray-100 backdrop-blur-sm rounded-[36px] border-2 border-gray-200/30 shadow-xl shadow-gray-900/20"
          >
            <div className="flex items-center gap-3 mb-5">
